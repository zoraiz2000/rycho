...
export default function FollowingPage({params} : {params: {id: string}}) {
    ...
    const fetchfollowerList = async () => {
        try {
            const response = await axios.get(`/api/users/profile?action=getFollowers&spotifyId=${params.id}`);
    ...
    return (        
        <div>
            <h1 className="text-4xl font-semibold mb-4 mt-8 text-center text-black">Followers</h1>
